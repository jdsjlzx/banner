...
### 联系方式
* 如果有问题可以加群大家一起交流，QQ群号:250468947
...
|setImages(List<?> imagesUrl)| 设置轮播图片(所有设置参数方法都放在此方法之前执行)|无
...
* 在你的根build.gradle文件中增加JitPack仓库依赖:
```groovy
allprojects {
    repositories {
...
```
* 在你的model的build.gradle文件中增加banner依赖
```groovy
dependencies{
    compile 'com.github.jdsjlzx:banner:1.0.0'  //最新版本
}
```
